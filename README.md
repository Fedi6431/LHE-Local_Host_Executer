...
- Debian Linux Distribution Installer: Before running installer.sh you need to open the terminal as root in the installer folder and type "chmod +x /bin/zsh" after typing it press enter and type "chmod +x installer.sh" and to finish to run the installer./installer.sh
### Server
